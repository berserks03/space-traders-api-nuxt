...
*/
export class ShipConditionEvent {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "symbol",
            "baseName": "symbol",
            "type": "ShipConditionEventSymbolEnum",
            "format": ""
        },
        {
            "name": "component",
            "baseName": "component",
            "type": "ShipConditionEventComponentEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return ShipConditionEvent.attributeTypeMap;
    }
...
export enum ShipConditionEventSymbolEnum {
...
export enum ShipConditionEventComponentEnum {
    Frame = 'FRAME',
    Reactor = 'REACTOR',
    Engine = 'ENGINE'
}
