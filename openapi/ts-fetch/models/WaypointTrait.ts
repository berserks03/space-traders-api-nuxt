...
import {
    ...
    WaypointTraitSymbolToJSONTyped,
 ...
 */
export function instanceOfWaypointTrait(value: object): value is WaypointTrait {
...
export function WaypointTraitToJSON(json: any): WaypointTrait {
    return WaypointTraitToJSONTyped(json, false);
}

export function WaypointTraitToJSONTyped(value?: WaypointTrait | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
