...
export function DeliverContractRequestToJSON(json: any): DeliverContractRequest {
    return DeliverContractRequestToJSONTyped(json, false);
}

export function DeliverContractRequestToJSONTyped(value?: DeliverContractRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
