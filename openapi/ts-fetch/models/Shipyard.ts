...
import {
    ...
    ShipyardShipTypesInnerToJSONTyped,
...
import {
    ...
    ShipyardTransactionToJSONTyped,
 ...
 */
export function instanceOfShipyard(value: object): value is Shipyard {
    if (!('symbol' in value) || value['symbol'] === undefined) return false;
    if (!('shipTypes' in value) || value['shipTypes'] === undefined) return false;
    if (!('modificationsFee' in value) || value['modificationsFee'] === undefined) return false;
    return true;
}
...
export function ShipyardFromJSONTyped(json: any, ignoreDiscriminator: boolean): Shipyard {
    ...
    return {
        ...
        'transactions': json['transactions'] == null ? undefined : ((json['transactions'] as Array<any>).map(ShipyardTransactionFromJSON)),
        'ships': json['ships'] == null ? undefined : ((json['ships'] as Array<any>).map(ShipyardShipFromJSON)),
        'modificationsFee': json['modificationsFee'],
    };
}

export function ShipyardToJSON(json: any): Shipyard {
    return ShipyardToJSONTyped(json, false);
}

export function ShipyardToJSONTyped(value?: Shipyard | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'transactions': value['transactions'] == null ? undefined : ((value['transactions'] as Array<any>).map(ShipyardTransactionToJSON)),
        'ships': value['ships'] == null ? undefined : ((value['ships'] as Array<any>).map(ShipyardShipToJSON)),
