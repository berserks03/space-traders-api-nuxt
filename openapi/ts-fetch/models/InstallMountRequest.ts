 ...
 */
export function instanceOfInstallMountRequest(value: object): value is InstallMountRequest {
...
export function InstallMountRequestToJSON(json: any): InstallMountRequest {
    return InstallMountRequestToJSONTyped(json, false);
}

export function InstallMountRequestToJSONTyped(value?: InstallMountRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
