...
export function ShipReactorToJSON(json: any): ShipReactor {
    return ShipReactorToJSONTyped(json, false);
}

export function ShipReactorToJSONTyped(value?: ShipReactor | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
