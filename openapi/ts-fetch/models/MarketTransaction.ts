 ...
 */
export function instanceOfMarketTransaction(value: object): value is MarketTransaction {
...
export function MarketTransactionToJSON(json: any): MarketTransaction {
    return MarketTransactionToJSONTyped(json, false);
}

export function MarketTransactionToJSONTyped(value?: MarketTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
