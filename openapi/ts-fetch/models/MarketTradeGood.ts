 ...
 */
export function instanceOfMarketTradeGood(value: object): value is MarketTradeGood {
    if (!('symbol' in value) || value['symbol'] === undefined) return false;
    if (!('type' in value) || value['type'] === undefined) return false;
    if (!('tradeVolume' in value) || value['tradeVolume'] === undefined) return false;
...
export function MarketTradeGoodToJSON(json: any): MarketTradeGood {
    return MarketTradeGoodToJSONTyped(json, false);
}

export function MarketTradeGoodToJSONTyped(value?: MarketTradeGood | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
