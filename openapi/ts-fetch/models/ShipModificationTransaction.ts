 ...
 */
export function instanceOfShipModificationTransaction(value: object): value is ShipModificationTransaction {
...
export function ShipModificationTransactionToJSON(json: any): ShipModificationTransaction {
    return ShipModificationTransactionToJSONTyped(json, false);
}

export function ShipModificationTransactionToJSONTyped(value?: ShipModificationTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
