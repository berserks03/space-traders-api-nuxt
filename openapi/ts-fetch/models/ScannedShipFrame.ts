 ...
 */
export function instanceOfScannedShipFrame(value: object): value is ScannedShipFrame {
...
export function ScannedShipFrameToJSON(json: any): ScannedShipFrame {
    return ScannedShipFrameToJSONTyped(json, false);
}

export function ScannedShipFrameToJSONTyped(value?: ScannedShipFrame | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
