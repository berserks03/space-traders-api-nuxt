 ...
 */
export function instanceOfRemoveMountRequest(value: object): value is RemoveMountRequest {
...
export function RemoveMountRequestToJSON(json: any): RemoveMountRequest {
    return RemoveMountRequestToJSONTyped(json, false);
}

export function RemoveMountRequestToJSONTyped(value?: RemoveMountRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
