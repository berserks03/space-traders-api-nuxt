 ...
 */
export function instanceOfScannedShipReactor(value: object): value is ScannedShipReactor {
...
export function ScannedShipReactorToJSON(json: any): ScannedShipReactor {
    return ScannedShipReactorToJSONTyped(json, false);
}

export function ScannedShipReactorToJSONTyped(value?: ScannedShipReactor | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
