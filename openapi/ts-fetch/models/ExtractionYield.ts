 ...
 */
export function instanceOfExtractionYield(value: object): value is ExtractionYield {
...
export function ExtractionYieldToJSON(json: any): ExtractionYield {
    return ExtractionYieldToJSONTyped(json, false);
}

export function ExtractionYieldToJSONTyped(value?: ExtractionYield | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
