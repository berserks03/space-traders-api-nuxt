 ...
 */
export function instanceOfShipyardShipTypesInner(value: object): value is ShipyardShipTypesInner {
...
export function ShipyardShipTypesInnerToJSON(json: any): ShipyardShipTypesInner {
    return ShipyardShipTypesInnerToJSONTyped(json, false);
}

export function ShipyardShipTypesInnerToJSONTyped(value?: ShipyardShipTypesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
