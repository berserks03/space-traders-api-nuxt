...
export function GetSystemWaypointsTraitsParameterToJSON(json: any): any {
    return GetSystemWaypointsTraitsParameterToJSONTyped(json, false);
}

export function GetSystemWaypointsTraitsParameterToJSONTyped(value?: GetSystemWaypointsTraitsParameter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
