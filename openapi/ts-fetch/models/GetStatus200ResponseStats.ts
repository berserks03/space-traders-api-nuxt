 ...
 */
export function instanceOfGetStatus200ResponseStats(value: object): value is GetStatus200ResponseStats {
...
export function GetStatus200ResponseStatsToJSON(json: any): GetStatus200ResponseStats {
    return GetStatus200ResponseStatsToJSONTyped(json, false);
}

export function GetStatus200ResponseStatsToJSONTyped(value?: GetStatus200ResponseStats | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
