...
export function ContractDeliverGoodFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContractDeliverGood {
    if (json == null) {
        return json;
    }
    return {
...
export function ContractDeliverGoodToJSON(json: any): ContractDeliverGood {
    return ContractDeliverGoodToJSONTyped(json, false);
}

export function ContractDeliverGoodToJSONTyped(value?: ContractDeliverGood | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
