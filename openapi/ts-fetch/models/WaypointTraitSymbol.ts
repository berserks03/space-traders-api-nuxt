...
export function instanceOfWaypointTraitSymbol(value: any): boolean {
    for (const key in WaypointTraitSymbol) {
        if (Object.prototype.hasOwnProperty.call(WaypointTraitSymbol, key)) {
            if (WaypointTraitSymbol[key as keyof typeof WaypointTraitSymbol] === value) {
                return true;
            }
        }
    }
...
export function WaypointTraitSymbolToJSONTyped(value: any, ignoreDiscriminator: boolean): WaypointTraitSymbol {
    return value as WaypointTraitSymbol;
}
