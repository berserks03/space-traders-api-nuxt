...
export function instanceOfWaypointType(value: any): boolean {
    for (const key in WaypointType) {
        if (Object.prototype.hasOwnProperty.call(WaypointType, key)) {
            if (WaypointType[key as keyof typeof WaypointType] === value) {
                return true;
            }
        }
    }
...
export function WaypointTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): WaypointType {
    return value as WaypointType;
}
