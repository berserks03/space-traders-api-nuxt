...
/**
 * Check if a given object implements the ShipFrame interface.
 */
export function instanceOfShipFrame(value: object): value is ShipFrame {
    ...
    if (!('moduleSlots' in value) || value['moduleSlots'] === undefined) return false;
    if (!('mountingPoints' in value) || value['mountingPoints'] === undefined) return false;
    if (!('fuelCapacity' in value) || value['fuelCapacity'] === undefined) return false;
...
export function ShipFrameFromJSON(json: any): ShipFrame {
    return ShipFrameFromJSONTyped(json, false);
}

export function ShipFrameFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipFrame {
    if (json == null) {
        return json;
    }
    return {
...
export function ShipFrameToJSON(json: any): ShipFrame {
    return ShipFrameToJSONTyped(json, false);
}

export function ShipFrameToJSONTyped(value?: ShipFrame | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
