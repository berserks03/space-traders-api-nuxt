...
export function instanceOfFactionTraitSymbol(value: any): boolean {
    for (const key in FactionTraitSymbol) {
        if (Object.prototype.hasOwnProperty.call(FactionTraitSymbol, key)) {
            if (FactionTraitSymbol[key as keyof typeof FactionTraitSymbol] === value) {
                return true;
            }
        }
    }
...
export function FactionTraitSymbolToJSONTyped(value: any, ignoreDiscriminator: boolean): FactionTraitSymbol {
    return value as FactionTraitSymbol;
}
