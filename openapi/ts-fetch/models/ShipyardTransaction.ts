 ...
 */
export function instanceOfShipyardTransaction(value: object): value is ShipyardTransaction {
...
export function ShipyardTransactionToJSON(json: any): ShipyardTransaction {
    return ShipyardTransactionToJSONTyped(json, false);
}

export function ShipyardTransactionToJSONTyped(value?: ShipyardTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
