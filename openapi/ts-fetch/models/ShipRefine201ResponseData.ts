...
import {
    ...
    ShipRefine201ResponseDataProducedInnerToJSONTyped,
 ...
 */
export function instanceOfShipRefine201ResponseData(value: object): value is ShipRefine201ResponseData {
    if (!('cargo' in value) || value['cargo'] === undefined) return false;
    if (!('cooldown' in value) || value['cooldown'] === undefined) return false;
    if (!('produced' in value) || value['produced'] === undefined) return false;
...
export function ShipRefine201ResponseDataToJSON(json: any): ShipRefine201ResponseData {
    return ShipRefine201ResponseDataToJSONTyped(json, false);
}

export function ShipRefine201ResponseDataToJSONTyped(value?: ShipRefine201ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
