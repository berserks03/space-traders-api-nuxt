 ...
 */
export function instanceOfExtraction(value: object): value is Extraction {
    if (!('shipSymbol' in value) || value['shipSymbol'] === undefined) return false;
    if (!('_yield' in value) || value['_yield'] === undefined) return false;
    return true;
}
...
export function ExtractionToJSON(json: any): Extraction {
    return ExtractionToJSONTyped(json, false);
}

export function ExtractionToJSONTyped(value?: Extraction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
