...
export function instanceOfTradeSymbol(value: any): boolean {
    for (const key in TradeSymbol) {
        if (Object.prototype.hasOwnProperty.call(TradeSymbol, key)) {
            if (TradeSymbol[key as keyof typeof TradeSymbol] === value) {
                return true;
            }
        }
    }
...
export function TradeSymbolToJSONTyped(value: any, ignoreDiscriminator: boolean): TradeSymbol {
    return value as TradeSymbol;
}
