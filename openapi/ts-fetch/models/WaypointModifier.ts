...
import {
    ...
    WaypointModifierSymbolToJSONTyped,
 ...
 */
export function instanceOfWaypointModifier(value: object): value is WaypointModifier {
...
export function WaypointModifierToJSON(json: any): WaypointModifier {
    return WaypointModifierToJSONTyped(json, false);
}

export function WaypointModifierToJSONTyped(value?: WaypointModifier | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
