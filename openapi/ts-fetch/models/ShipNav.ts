...
export function ShipNavToJSON(json: any): ShipNav {
    return ShipNavToJSONTyped(json, false);
}

export function ShipNavToJSONTyped(value?: ShipNav | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
