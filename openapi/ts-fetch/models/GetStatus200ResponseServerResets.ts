 ...
 */
export function instanceOfGetStatus200ResponseServerResets(value: object): value is GetStatus200ResponseServerResets {
...
export function GetStatus200ResponseServerResetsToJSON(json: any): GetStatus200ResponseServerResets {
    return GetStatus200ResponseServerResetsToJSONTyped(json, false);
}

export function GetStatus200ResponseServerResetsToJSONTyped(value?: GetStatus200ResponseServerResets | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
